...
Entre que una idea aparece y esta se vuelve algo que se lleva a cabo o pone en práctica, hay 4 etapas, cada siguiente etapa requiere más detalle que la anterior:
1. Idea 
```
    Qué (quid), Por Qué (Cur)
```
2. Plan 
```
    Cómo (quomodo),	Quién Quienes (quis), Cuánto (quad)
```
3. Proyecto 
```
    Dónde (ubi), Cuándo (quando), Con qué medios o ayudas (quibus auxiliis)
```
4. Ejecución
